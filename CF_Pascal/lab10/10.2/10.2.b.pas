...
VAR
  BracketsReadingCondition, AssignmentSign, PerfomanceCondition, PrevSign, IsErr: CHAR;
                                            ...
                                            ELSE
                                              ...
                                              ELSE
                                                ...
                                                THEN
                                                  ...
                                                  END           
                                  END;            
                                IF BracketsReadingCondition = 'D'
                                THEN
                                  BEGIN
                                    W1 := W2; W2 := W3; W3 := W4; W4 := W5; W5 := W6; W6 := W7; 
                                    BracketsReadingCondition := 'A'
                                  END 
                              END; {Конец функции PrintBrackets}
